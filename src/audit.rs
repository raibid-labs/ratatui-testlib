...
impl TestAuditor {
    ...
    pub fn scaffold_test_file(tests: &[PlaceholderTest], config: &ScaffoldConfig) -> String {
        ...
        output.push_str("// Generated by ratatui_testlib::audit::TestAuditor\n\n");
    ...
    fn generate_imports(config: &ScaffoldConfig) -> String {
        match config.harness {
            ...
            HarnessType::AsyncTuiTestHarness => {
                "use ratatui_testlib::{AsyncTuiTestHarness, Result};\n\
                 use portable_pty::CommandBuilder;\n\
                 use tokio::test;"
                    .to_string()
            }
            ...
            HarnessType::ScarabTestHarness => {
                "use ratatui_testlib::{ScarabTestHarness, ScarabConfig, Result};"
                    .to_string()
            }
        }
    }
